            ...
            promo: {
              ...
              endGame: {
                ...
                contest: {
                  ...
                  prize: {
                    title: 'Призы:',
                    gold: '1 место: $$$ — смотри в паблике, настольная игра «Змеи и лестницы» (вышлем почтой), и стихотворение от меня!',
                    silver: '2 место: настольная игра «Змеи и лестницы» (вышлем почтой), и стихотворение от меня!',
